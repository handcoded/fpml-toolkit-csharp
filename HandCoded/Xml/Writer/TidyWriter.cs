...
{
	/// <summary>
	/// The <b>TidyWriter</b> produces a formated XML document that uses
	/// indentation to show the structure of the information. For example:
	/// <code>
	...
	/// </code>
	/// </summary>
	public class TidyWriter : XmlWriter
	{
		/// <summary>
		/// Constructs a <b>NestedWriter</b>.
		/// </summary>
		/// <param name="writer">The <see cref="TextWriter"/> to write to.</param>
		public TidyWriter (TextWriter writer)
			: base (writer)
		{ }
		...
		public TidyWriter (Stream stream, Encoding encoding)
