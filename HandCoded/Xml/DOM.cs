...
namespace HandCoded.Xml
{
	...
	public sealed class DOM
	{
		...
		/// <summary>
		/// Finds the parent <see cref="XmlElement"/> of the given <see cref="XmlElement"/>.
		/// </summary>
		/// <param name="element">The context <see cref="XmlElement"/>.</param>
        ...
        /// <summary>
        /// Finds the grand parent <see cref="XmlElement"/> of the given context
        /// <see cref="XmlElement"/>.
        /// </summary>
        /// <param name="element">The context <see cref="XmlElement"/>.</param>
        /// <returns>The grand parent <see cref="XmlElement"/> or <CODE>null</CODE> if
	    ///	the context <see cref="XmlElement"/> was the near the root element.</returns>
        public static XmlElement GetGrandParent (XmlElement element)
        {
            return (GetParent (GetParent (element)));
        }

        /// <summary>
        /// Finds the great grand parent <see cref="XmlElement"/> of the given context
        /// <see cref="XmlElement"/>.
        /// </summary>
        /// <param name="element">The context <see cref="XmlElement"/>.</param>
        /// <returns>The great grand parent <see cref="XmlElement"/> or <CODE>null</CODE> if
	    ///	the context <see cref="XmlElement"/> was the near the root element.</returns>
        public static XmlElement GetGreatGrandParent (XmlElement element)
        {
            return (GetParent (GetParent (GetParent (element))));
        }
