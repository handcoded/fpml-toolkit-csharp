...
namespace HandCoded.FpML.Validation
{
	...
	public sealed class FxRules : FpMLRuleSet
	{
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 3-0 thru
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 3-0 or later
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 4-0 or later
	    /// confirmation view document.
        /// </summary>
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 4.2 thru 4-*
        /// confirmation view document.
        /// </summary>
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 4-2 or later
        /// confirmation view document.
        /// </summary>
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects any FpML 5-1 or later
	    /// confirmation view document.
        /// </summary>
		...
		public static readonly Rule	RULE01_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-1[OLD]", new RuleDelegate (Rule01_OLD));
		...
		public static readonly Rule	RULE02_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-2[OLD]", new RuleDelegate (Rule02_OLD));
		...
		public static readonly Rule	RULE04_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-4[OLD]", new RuleDelegate (Rule04_OLD));
		...
		public static readonly Rule	RULE05_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-5[OLD]", new RuleDelegate (Rule05_OLD));
		...
		public static readonly Rule	RULE06_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-6[OLD]", new RuleDelegate (Rule06_OLD));
		...
		public static readonly Rule	RULE07_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-7[OLD]", new RuleDelegate (Rule07_OLD));
		...
		public static readonly Rule	RULE08_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-8[OLD]", new RuleDelegate (Rule08_OLD));
		...
		public static readonly Rule	RULE08
			= new DelegatedRule (R5_1__LATER, "fx-8", new RuleDelegate (Rule08));
		...
		public static readonly Rule	RULE09_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-9[OLD]", new RuleDelegate (Rule09_OLD));
		...
		public static readonly Rule	RULE09
			= new DelegatedRule (R5_1__LATER, "fx-9", new RuleDelegate (Rule09));
		...
		public static readonly Rule	RULE10_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-10[OLD]", new RuleDelegate (Rule10_OLD));
		...
		public static readonly Rule	RULE10
			= new DelegatedRule (R5_1__LATER, "fx-10", new RuleDelegate (Rule10));
		...
		public static readonly Rule	RULE11_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-11[OLD]", new RuleDelegate (Rule11_OLD));
		...
		public static readonly Rule	RULE11
			= new DelegatedRule (R5_1__LATER, "fx-11", new RuleDelegate (Rule11));
		...
		public static readonly Rule	RULE12_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-12[OLD]", new RuleDelegate (Rule12_OLD));
		...
		public static readonly Rule	RULE12
			= new DelegatedRule (R5_1__LATER, "fx-12", new RuleDelegate (Rule12));
		...
		public static readonly Rule	RULE13_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-13[OLD]", new RuleDelegate (Rule13_OLD));
		...
		public static readonly Rule	RULE14_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-14[OLD]", new RuleDelegate (Rule14_OLD));
		...
		public static readonly Rule	RULE14
			= new DelegatedRule (R5_1__LATER, "fx-14", new RuleDelegate (Rule14));
		...
		public static readonly Rule	RULE15_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-15[OLD]", new RuleDelegate (Rule15_OLD));
		...
		public static readonly Rule	RULE16_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-16[OLD]", new RuleDelegate (Rule16_OLD));
		...
		public static readonly Rule	RULE17_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-17[OLD]", new RuleDelegate (Rule17_OLD));
		...
		public static readonly Rule	RULE18_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-18[OLD]", new RuleDelegate (Rule18_OLD));
		...
		public static readonly Rule	RULE18
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R5_1__LATER), "fx-18", new RuleDelegate (Rule18));
		...
		public static readonly Rule	RULE19_OLD
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R3_0__R4_X), "fx-19[OLD]", new RuleDelegate (Rule19_OLD));
		...
		public static readonly Rule	RULE19
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R5_1__LATER), "fx-19", new RuleDelegate (Rule19));
		...
		public static readonly Rule	RULE20_OLD
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R3_0__R4_X), "fx-20[OLD]", new RuleDelegate (Rule20_OLD));
		...
		public static readonly Rule	RULE20
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R5_1__LATER), "fx-20", new RuleDelegate (Rule20));
		...
		public static readonly Rule	RULE21_OLD
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R3_0__R4_X), "fx-21[OLD]", new RuleDelegate (Rule21_OLD));
		...
		public static readonly Rule	RULE21
			= new DelegatedRule (Precondition.And (FX_SINGLE_LEG, R5_1__LATER), "fx-21", new RuleDelegate (Rule21));
		...
		public static readonly Rule	RULE22_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-22[OLD]", new RuleDelegate (Rule22_OLD));
		...
		public static readonly Rule	RULE22
			= new DelegatedRule (R5_1__LATER, "fx-22", new RuleDelegate (Rule22));
		...
		public static readonly Rule	RULE23_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-23[OLD]", new RuleDelegate (Rule23_OLD));
		...
		public static readonly Rule	RULE23
			= new DelegatedRule (R5_1__LATER, "fx-23", new RuleDelegate (Rule23));
		...
		public static readonly Rule	RULE24_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-24[OLD]", new RuleDelegate (Rule24_OLD));
		...
		public static readonly Rule	RULE25_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-25[OLD]", new RuleDelegate (Rule25_OLD));
		...
		public static readonly Rule	RULE26_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-26[OLD]", new RuleDelegate (Rule26_OLD));
		...
		public static readonly Rule	RULE26
			= new DelegatedRule (R5_1__LATER, "fx-26", new RuleDelegate (Rule26));
		...
		public static readonly Rule	RULE28_OLD
			= new DelegatedRule (R3_0__LATER, "fx-28[OLD]", new RuleDelegate (Rule28_OLD));
		...
		public static readonly Rule	RULE29_OLD
			= new DelegatedRule (R3_0__LATER, "fx-29[OLD]", new RuleDelegate (Rule29_OLD));
		...
		public static readonly Rule	RULE30_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-30[OLD]", new RuleDelegate (Rule30_OLD));
		...
		public static readonly Rule	RULE30
			= new DelegatedRule (R5_1__LATER, "fx-30", new RuleDelegate (Rule30));
		...
		public static readonly Rule	RULE31_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-31[OLD]", new RuleDelegate (Rule31_OLD));
		...
		public static readonly Rule	RULE32_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-32[OLD]", new RuleDelegate (Rule32_OLD));
		...
		public static readonly Rule	RULE32
			= new DelegatedRule (R5_1__LATER, "fx-32", new RuleDelegate (Rule32));
		...
		public static readonly Rule	RULE34_OLD
			= new DelegatedRule (R3_0__LATER, "fx-34[OLD]", new RuleDelegate (Rule34_OLD));
		...
		public static readonly Rule	RULE35_OLD
			= new DelegatedRule (R3_0__LATER, "fx-35[OLD]", new RuleDelegate (Rule35_OLD));
		...
		public static readonly Rule	RULE36_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-36[OLD]", new RuleDelegate (Rule36_OLD));
		...
		public static readonly Rule	RULE36
			= new DelegatedRule (Precondition.And (TRADE, R5_1__LATER), "fx-36", new RuleDelegate (Rule36));
		...
		public static readonly Rule RULE36B_OLD
			= new DelegatedRule (Precondition.And (CONTRACT, R4_2__R4_X), "fx-36b[OLD]", new RuleDelegate (Rule36B_OLD));
		...
		public static readonly Rule	RULE37_OLD
			= new DelegatedRule (Precondition.And (TRADE, R3_0__R4_X), "fx-37[OLD]", new RuleDelegate (Rule37_OLD));
		...
		public static readonly Rule RULE37B_OLD
			= new DelegatedRule (Precondition.And (CONTRACT, R4_2__R4_X), "fx-37b[OLD]", new RuleDelegate (Rule37B_OLD));
		...
		public static readonly Rule	RULE38_OLD
			= new DelegatedRule (Precondition.And (TRADE, R3_0__R4_X), "fx-38[OLD]", new RuleDelegate (Rule38_OLD));
		...
		public static readonly Rule	RULE38
			= new DelegatedRule (Precondition.And (TRADE, R5_1__LATER), "fx-38", new RuleDelegate (Rule38));
		...
		public static readonly Rule RULE38B_OLD
			= new DelegatedRule (Precondition.And (CONTRACT, R4_2__R4_X), "fx-38b[OLD]", new RuleDelegate (Rule38B_OLD));
		...
		public static readonly Rule	RULE39
			= new DelegatedRule (Precondition.And (TRADE, R3_0__LATER), "fx-39", new RuleDelegate (Rule39));
		...
		public static readonly Rule RULE39B_OLD
			= new DelegatedRule (Precondition.And (CONTRACT, R4_2__R4_X), "fx-39b[OLD]", new RuleDelegate (Rule39B_OLD));
		...
		public static readonly Rule	RULE40_OLD
			= new DelegatedRule (Precondition.And (TRADE, R3_0__R4_X), "fx-40[OLD]", new RuleDelegate (Rule40_OLD));
		...
		public static readonly Rule	RULE40
			= new DelegatedRule (Precondition.And (TRADE, R5_1__LATER), "fx-40", new RuleDelegate (Rule40));
		...
		public static readonly Rule RULE40B_OLD
			= new DelegatedRule (Precondition.And (CONTRACT, R4_2__R4_X), "fx-40b[OLD]", new RuleDelegate (Rule40B_OLD));
		...
		public static readonly Rule	RULE41_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-41[OLD]", new RuleDelegate (Rule41_OLD));
		...
		public static readonly Rule	RULE42_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-42[OLD]", new RuleDelegate (Rule42_OLD));
		...
		public static readonly Rule	RULE43_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-43[OLD]", new RuleDelegate (Rule43_OLD));
		...
		public static readonly Rule	RULE44_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-44[OLD]", new RuleDelegate (Rule44_OLD));
		...
		public static readonly Rule	RULE45_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-45[OLD]", new RuleDelegate (Rule45_OLD));
		...
		public static readonly Rule	RULE45
			= new DelegatedRule (R5_1__LATER, "fx-45", new RuleDelegate (Rule45));
		...
		public static readonly Rule	RULE46_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-46[OLD]", new RuleDelegate (Rule46_OLD));
		...
		public static readonly Rule	RULE47_OLD
			= new DelegatedRule (R3_0__R4_X, "fx-47[OLD]", new RuleDelegate (Rule47_OLD));
		...
		public static readonly Rule	RULE48
			= new DelegatedRule (R5_1__LATER, "fx-48", new RuleDelegate (Rule48));
		...
		public static readonly Rule	RULE49
			= new DelegatedRule (Precondition.And (FX_SWAP_LEG, R5_1__LATER), "fx-49", new RuleDelegate (Rule49));
		...
		public static readonly Rule	RULE50
			= new DelegatedRule (Precondition.And (FX_SWAP_LEG, R5_1__LATER), "fx-50", new RuleDelegate (Rule50));
		...
		public static readonly Rule	RULE51
			= new DelegatedRule (Precondition.And (FX_SWAP_LEG, R5_1__LATER), "fx-51", new RuleDelegate (Rule51));
		...
		public static readonly Rule	RULE52
			= new DelegatedRule (Precondition.And (TRADE, R5_1__LATER), "fx-52", new RuleDelegate (Rule52));
		...
		public static readonly Rule	RULE53
			= new DelegatedRule (Precondition.And (TRADE, R5_1__LATER), "fx-53", new RuleDelegate (Rule53));
		...
		private static bool Rule03 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
		{
			...
			foreach (XmlElement	context in list) {
				...
				if (ToDecimal (rate).CompareTo (ToDecimal (spot) + ToDecimal (forward)) == 0)
					continue;
		...
		private static bool Rule12 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
		{
			...
			foreach (XmlElement context in list) {
				...
				XmlElement	start	= XPath.Path (schedule, "startDate");
				XmlElement	end		= XPath.Path (schedule, "endDate");
				XmlElement	freq	= XPath.Path (schedule, "calculationPeriodFrequency");
				XmlElement	roll	= XPath.Path (freq, "rollConvention");
		...
		private static bool Rule32 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
		{
			...
			foreach (XmlElement context in list) {
				...
				XmlElement	payerAccount	 = XPath.Path (context, "payerAccountReference");
				XmlElement	receiverAccount  = XPath.Path (context, "receiverAccountReference");
		...
		private static bool Rule36 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
		{
			...
			foreach (XmlElement context in list) {
				XmlElement	tradeDate	 = XPath.Path (context, "tradeHeader", "tradeDate");
				XmlElement	expiryDate	 = XPath.Path (context, "fxOption", "europeanExercise", "expiryDate");
