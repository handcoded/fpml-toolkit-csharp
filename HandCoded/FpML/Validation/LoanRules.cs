...
namespace HandCoded.FpML.Validation
{
	...
	public sealed class LoanRules : FpMLRuleSet
	{
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 4-4 and later
	    /// confirmation view documents.
        /// </summary>
	    private static readonly Precondition	R4_4__R4_X
		    = Precondition.And (
		...
		public static readonly Rule RULE01
            = new DelegatedRule (R4_4__R4_X, "ln-1", Rule01);
		...
		public static readonly Rule RULE02
            = new DelegatedRule (R4_4__R4_X, "ln-2", Rule02);
		...
		public static readonly Rule RULE03
            = new DelegatedRule (R4_4__R4_X, "ln-3", Rule03);
		...
		public static readonly Rule RULE04
            = new DelegatedRule (R4_4__R4_X, "ln-4", Rule04);
		...
		public static readonly Rule RULE05
            = new DelegatedRule (R4_4__R4_X, "ln-5", Rule05);

		public static readonly Rule RULE10
            = new DelegatedRule (R4_4__R4_X, "ln-10", Rule10);
