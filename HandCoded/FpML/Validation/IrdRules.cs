...
namespace HandCoded.FpML.Validation
{
	...
	public sealed class IrdRules : FpMLRuleSet
	{
        ...
        /// </summary>
	    private static readonly Precondition	IRD_PRODUCT
		    = new ContentPrecondition (
				    new String [] { "swap", "swaption", "fra", "capFloor", "bulletPayment" },
				    new String [] { "Swap", "Swaption", "Fra", "CapFloor", "BulletPayment" });
    	
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 1-0 thru 3-0
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 1-0 thru 4-6
	    /// confirmation view documents.
        /// </summary>
	    private static readonly Precondition	R1_0__R4_6
		    = Precondition.And (new Precondition [] {
				    IRD_PRODUCT,
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 1-0 thru 4-9
        /// confirmation view documents.
        /// </summary>
        private static readonly Precondition R1_0__R4_9
            = Precondition.And (new Precondition [] {
				    IRD_PRODUCT,
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 1-0 and later
	    /// confirmation view documents.
        /// </summary>
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 4-0 and later
	    /// confirmation view documents.
        /// </summary>
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 4-7 and later
	    /// confirmation view documents.
        /// </summary>
        private static readonly Precondition R4_7__LATER
		    = Precondition.And (new Precondition [] {
				    IRD_PRODUCT,
        ...
        /// <summary>
        /// A <see cref="Precondition"/> instance that detects FpML 5-0 and later
        /// confirmation view documents.
        /// </summary>
		...
		public static readonly Rule	RULE08_OLD
            = new DelegatedRule(Precondition.And (R1_0__R4_9, INTEREST_RATE_STREAM), "ird-8[OLD]", new RuleDelegate (Rule08_OLD));
        ...
        public static readonly Rule RULE08
            = new DelegatedRule (Precondition.And (R5_0__LATER, INTEREST_RATE_STREAM), "ird-8", new RuleDelegate (Rule08));
		...
		public static readonly Rule	RULE23
            = new DelegatedRule (R1_0__LATER, "ird-23", new RuleDelegate (Rule23));
		...
		public static readonly Rule	RULE24
            = new DelegatedRule (R1_0__LATER, "ird-24", new RuleDelegate (Rule24));
		...
		public static readonly Rule	RULE25_OLD
			= new DelegatedRule (R1_0__R4_6, "ird-25[OLD]", new RuleDelegate (Rule25_OLD));
		...
		public static readonly Rule	RULE25
			= new DelegatedRule (R4_7__LATER, "ird-25", new RuleDelegate (Rule25));
		...
		public static readonly Rule	RULE26
            = new DelegatedRule (R1_0__LATER, "ird-26", new RuleDelegate (Rule26));
		...
		public static readonly Rule	RULE27
            = new DelegatedRule (R1_0__LATER, "ird-27", new RuleDelegate (Rule27));
		...
		public static readonly Rule	RULE28_XLINK
			= new DelegatedRule (R1_0__R3_0, "ird-28[XLINK]", new RuleDelegate (Rule28_XLINK));
		...
		public static readonly Rule	RULE28
			= new DelegatedRule (R4_0__LATER, "ird-28", new RuleDelegate (Rule28));
		...
		public static readonly Rule	RULE29
            = new DelegatedRule (R1_0__LATER, "ird-29", new RuleDelegate (Rule29));
		...
		public static readonly Rule	RULE30
            = new DelegatedRule (R1_0__LATER, "ird-30", new RuleDelegate (Rule30));
		...
		public static readonly Rule	RULE31
            = new DelegatedRule (R1_0__LATER, "ird-31", new RuleDelegate (Rule31));
		...
		public static readonly Rule	RULE32
            = new DelegatedRule (R1_0__LATER, "ird-32", new RuleDelegate (Rule32));
		...
		public static readonly Rule	RULE33
            = new DelegatedRule (R1_0__LATER, "ird-33", new RuleDelegate (Rule33));
		...
		public static readonly Rule	RULE34
            = new DelegatedRule (R1_0__LATER, "ird-34", new RuleDelegate (Rule34));
		...
		public static readonly Rule	RULE35
            = new DelegatedRule (R1_0__LATER, "ird-35", new RuleDelegate (Rule35));
		...
		public static readonly Rule	RULE36
            = new DelegatedRule (R1_0__LATER, "ird-36", new RuleDelegate (Rule36));
		...
		public static readonly Rule	RULE38
            = new DelegatedRule (R1_0__LATER, "ird-38", new RuleDelegate (Rule38));
		...
		public static readonly Rule	RULE39
            = new DelegatedRule (R1_0__LATER, "ird-39", new RuleDelegate (Rule39));
		...
		public static readonly Rule	RULE40
            = new DelegatedRule (R1_0__LATER, "ird-40", new RuleDelegate (Rule40));
		...
		public static readonly Rule	RULE41
            = new DelegatedRule (R1_0__LATER, "ird-41", new RuleDelegate (Rule41));
		...
		public static readonly Rule	RULE42
            = new DelegatedRule (R1_0__LATER, "ird-42", new RuleDelegate (Rule42));
		...
		public static readonly Rule	RULE43
            = new DelegatedRule (R1_0__LATER, "ird-43", new RuleDelegate (Rule43));
		...
		public static readonly Rule	RULE44
            = new DelegatedRule (R1_0__LATER, "ird-44", new RuleDelegate (Rule44));
		...
		public static readonly Rule	RULE46_XLINK
			= new DelegatedRule (R1_0__R3_0, "ird-46[XLINK]", new RuleDelegate (Rule46_XLINK));
		...
		public static readonly Rule	RULE46
			= new DelegatedRule (R4_0__LATER, "ird-46", new RuleDelegate (Rule46));
		...
		public static readonly Rule	RULE47_XLINK
			= new DelegatedRule (R1_0__R3_0, "ird-47[XLINK]", new RuleDelegate (Rule47_XLINK));
        ...
        public static readonly Rule	RULE47
			= new DelegatedRule (R4_0__LATER, "ird-47", new RuleDelegate (Rule47));
		...
		public static readonly Rule	RULE48
            = new DelegatedRule (R1_0__LATER, "ird-48", new RuleDelegate (Rule48));
		...
		public static readonly Rule	RULE49
            = new DelegatedRule (R1_0__LATER, "ird-49", new RuleDelegate (Rule49));
		...
		public static readonly Rule	RULE55
            = new DelegatedRule (R1_0__LATER, "ird-55", new RuleDelegate (Rule55));
		...
		public static readonly Rule	RULE56
            = new DelegatedRule (R1_0__LATER, "ird-56", new RuleDelegate (Rule56));
		...
		public static readonly Rule	RULE57
            = new DelegatedRule (R1_0__LATER, "ird-57", new RuleDelegate (Rule57));
		...
		public static readonly Rule	RULE58
            = new DelegatedRule (R1_0__LATER, "ird-58", new RuleDelegate (Rule58));
		...
		public static readonly Rule	RULE60
            = new DelegatedRule (R1_0__LATER, "ird-60", new RuleDelegate (Rule60));
		...
		public static readonly Rule	RULE61
			= new DelegatedRule (R4_7__LATER, "ird-61", new RuleDelegate (Rule61));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule02 (name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule03(name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule04(name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule05 (name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule06 (name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule07 (name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule08_OLD (name, nodeIndex.GetElementsByType (DetermineNamespace (nodeIndex), "InterestRateStream"), errorHandler));

            return (
                  Rule08_OLD (name, nodeIndex.GetElementsByName ("swapStream"), errorHandler)
                & Rule08_OLD (name, nodeIndex.GetElementsByName ("capFloorStream"), errorHandler));
		}
        ...
        {
            if (nodeIndex.HasTypeInformation)
                return (Rule08 (name, nodeIndex.GetElementsByType (DetermineNamespace (nodeIndex), "InterestRateStream"), errorHandler));
        ...
        private static bool Rule08 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
        {
            ...
            foreach (XmlElement context in list) {
                ...
                payer = XPath.Path (context, "payerAccountReference");
                receiver = XPath.Path (context, "receiverAccountReference");
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule09 (name, nodeIndex.GetElementsByType(DetermineNamespace(nodeIndex), "InterestRateStream"), errorHandler));
        ...
        private static bool Rule12 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
        {
			...
			foreach (XmlElement context in list) {
                XmlElement      indexName = XPath.Path (context, "..", "calculationPeriodAmount", "calculation", "floatingRateCalculation", "floatingRateIndex");
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule30 (name, nodeIndex.GetElementsByType (DetermineNamespace (nodeIndex), "CalculationPeriod"), errorHandler));
		...
		private static bool Rule42 (string name, XmlNodeList list, ValidationErrorHandler errorHandler)
		{
			...
			foreach (XmlElement context in list) {
				...
				if ((exercise == null) || (termination == null) ||
                    Less (ToDate (exercise), ToDate (termination)))
					continue;
		...
		{
            if (nodeIndex.HasTypeInformation)
                return (Rule49 (name, nodeIndex.GetElementsByType (DetermineNamespace (nodeIndex), "ResetFrequency"), errorHandler));
